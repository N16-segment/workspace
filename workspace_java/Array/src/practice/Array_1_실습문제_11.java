...
//문제 11.
//(난이도 상) 간단한 성적처리 시스템을 만들어보자.// 국어, 영어, 수학점수를 입력받아 각 과목에 대한
// 점수 및 총점, 평균을 출력하는 프로그램을 만들어보자.
// 반드시 배열을 사용하도록 한다.
public class Array_1_실습문제_11 {
  public static void main(String[] args) {
    //----------변수-----------//
    Scanner sc = new Scanner(System.in);
    //0:국어, 1:영어,  2:수학, 3:총점
    int[] scores = new int[4];//과목수에서 + 1 한 요소의 크기
    //과목명을 저장하고 있는 배열
    ...
    //----------정수입력-----------//
    //0에서 100점 사이의 값을 입력받을 때 까지 반복(과목수만큼 반복)
